...
class SnippetCar2 extends React.Component {
  render() {
    return (
      <div
      ...
      >
        <div className="n-snippet-card2__hover">
          <div className="n-snippet-card2__toolbar">
            ...
            >
              ...
              <div
                className="n-product-toolbar__item link link_theme_minor hint n-user-lists_type_compare i-bem n-user-lists_type_compare_in-list_no n-user-lists_type_compare_js_inited hint_js_inited _popup2-destructor _popup2-destructor_js_inited link_js_inited"
                data-bem="{n-user-lists_type_compare:{id:1963924408,name:\u041C\u043E\u043D\u0438\u0442\u043E\u0440 Viewsonic VA2719-2K-smhd,hid:91052,catname:\u041C\u043E\u043D\u0438\u0442\u043E\u0440\u044B,image:{url://avatars.mds.yandex.net/get-mpic/466729/img_id5595280924220369215.jpeg/2hq},link:/compare?track=rmmbr,inComparison:false},hint:{to:top}}"
              >
        ...
        <div className="n-snippet-card2__part n-snippet-card2__part_type_left">
          <a
            ...
            href="https://market.yandex.by/product--monitor-viewsonic-va2719-2k-smhd/1963924408?show-uid=15435082885568986297216001&nid=54539&context=search"
          ...
          <div className="n-snippet-card2__header n-snippet-card2__header_has_rating">
            ...
            <div className="n-snippet-card2__header-stickers">
              <a
                ...
                href="https://market.yandex.by/product--monitor-viewsonic-va2719-2k-smhd/1963924408/reviews?show-uid=15435082885568986297216001"
              >
                <div
          ...
          <div className="n-snippet-card2__top">
              ...
              <div className="n-snippet-card2__main-price">
                <div className="n-snippet-card2__main-price-wrapper">
                  <a
                    ...
                    href="https://market.yandex.by/product--monitor-viewsonic-va2719-2k-smhd/1963924408/offers?track=srchlink&show-uid=15435082885568986297216001"
            ...
            <div className="n-snippet-card2__more-prices-link">
              <a
                ...
                href="https://market.yandex.by/product--monitor-viewsonic-va2719-2k-smhd/1963924408/offers?track=srchbtn&show-uid=15435082885568986297216001&context=search"
              >
                3 предложения
              </a>{" "}
