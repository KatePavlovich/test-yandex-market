                      ...
                      <span className="suggest2-form__node">
                        <span className="search2__input">
                          ...
                          <div
                            ...
                            data-bem="{popup:{directions:bottom-left,position:{left:0}},suggest2-detect:,suggest2:{url://yandex.ru/suggest-market/suggest-market-rich-weights_boost_market_suggests?v=2&enable-continuation=1&group_sort=max&hl=1&market_personal_num=2&market_personal=1,suggestHistoryRemoveUrl://yandex.ru/suggest-market/suggest-delete-text,data:{srv:market,wiz:TrWth},onFocus:request,submitBySelect:false,requestOnEmptyInput:true,updateOnEnterByKeyboard:false}}"
                          >
                  ...
                  <div className="header2__right">
                    ...
                    >
                      <span
                        ...
                        data-bem="{region-form-opener:{region:{id:157,source:50,name:\u041C\u0438\u043D\u0441\u043A,detectedName:\u041C\u0438\u043D\u0441\u043A,tld:by,country:149,isBySettings:false,isInternal:false,regSet:false,linguistics:{ablative:,accusative:\u041C\u0438\u043D\u0441\u043A,dative:\u041C\u0438\u043D\u0441\u043A\u0443,directional:,genitive:\u041C\u0438\u043D\u0441\u043A\u0430,instrumental:\u041C\u0438\u043D\u0441\u043A\u043E\u043C,locative:,nominative:\u041C\u0438\u043D\u0441\u043A,preposition:\u0432,prepositional:\u041C\u0438\u043D\u0441\u043A\u0435}}}}"
                      >
                      ...
                      <a
                        className="link header2-menu__item header2-menu__item_type_wishlist i-bem link_js_inited"
                        href="https://market.yandex.by/my/wishlist?track=head"
                      >
                        <span className="header2-menu__icon-wrap">
                          <span
                            className="header2-menu__count personal-counter personal-counter_provider_wishlist i-bem personal-counter_js_inited"
                      ...
                      >
                        <span className="header2-menu__icon-wrap">
                          <span
                            className="header2-menu__count personal-counter personal-counter_provider_comparison i-bem personal-counter_js_inited"
                            data-bem="{personal-counter:{showDot:true,comparisonCount:0},header2-menu__count:{type:compare}}"
                          />
                          <span
                    ...
                    <div className="header2__nav">
                      <div
                        ...
                        data-bem="{header2-nav:{user:{isAuth:false,login:,name:null,UID:,yandexuid:9732058651522476364,region:{id:157,source:50,name:\u041C\u0438\u043D\u0441\u043A,detectedName:\u041C\u0438\u043D\u0441\u043A,tld:by,country:149,isBySettings:false,isInternal:false,regSet:false,linguistics:{ablative:,accusative:\u041C\u0438\u043D\u0441\u043A,dative:\u041C\u0438\u043D\u0441\u043A\u0443,directional:,genitive:\u041C\u0438\u043D\u0441\u043A\u0430,instrumental:\u041C\u0438\u043D\u0441\u043A\u043E\u043C,locative:,nominative:\u041C\u0438\u043D\u0441\u043A,preposition:\u0432,prepositional:\u041C\u0438\u043D\u0441\u043A\u0435}},comparisonCount:0},domain:ru,retpath:https://market.yandex.by,expFlags:{dsk_all-pages_discount:true,dsk_suggest-weight:2}}}"
                      >
                        ...
                        <div className="header2-nav__content">
                          <div className="header2-nav__user">
                            <div className="n-passport-suggest-popup-opener">
                              ...
                              >
                                <a
                                  className="button2 button2_pseudo_yes button2_size_ml button2_theme_gray user__login i-bem button2_js_inited"
                                  href="https://passport.yandex.by/auth?origin=market_desktop_header&retpath=https://market.yandex.by"
                                  role="button"
                                >
                                  <span className="button2__text">
